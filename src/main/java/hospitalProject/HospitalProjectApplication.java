...
class HospitalProjectApplication {
    ...
    CommandLineRunner start(IHospitalService hospitalService,
        ...
        return args -> {
            Stream.of("Ichraq","Sabrine","Mohammed")
                    .forEach(name->{
            ...
            Stream.of("Loubna","Mustapha","Saad")
                    .forEach(name-> {
            ...
            Patient patient=patientRepository.findByNom("Ichraq");
            Patient patient1=patientRepository.findById(1L).orElse(null);
            Medecin medecin=medecinRepository.findByNom("Mustapha");
